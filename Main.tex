...
%% article.
\begin{abstract}
Blind and visually impaired (BVI) creators report strong aspirations to make video, yet sustainable training is scarce and mainstream editing applications remain largely incompatible with screen readers. Research prototypes demonstrate technical feasibility but are not publicly deployed, leaving learners reliant on tools that exist. We examine how ability-diverse teams learn video creation, drawing on seven workshops with 10 BVI participants and four tutors across two UK sites. Combining participant observation, video documentation, surveys, and interviews, we apply multimodal conversation analysis and reflexive thematic analysis. We identify three interlocking asymmetries shaping collaboration (expertise, tool ecosystems, and interaction paradigms) and four collaborative patterns through which participants navigate them: haptic mediation, cross-modal translation, task-specific delegation, and peer-to-peer assistance. We propose dynamic standard-making, the situated co-construction of temporary interactional standards between collaborators, as a reframing of accessibility that complements Universal Design for Learning by accounting for what cannot be designed in advance.
\end{abstract}
